...
├── App.jsx                         # State machine shell & route transitions
├── index.css                       # CSS custom properties, tokens & reset
...
The entire application runs on an explicit, linear 5-stage state machine managed in `App.jsx`:
