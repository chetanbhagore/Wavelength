...
```mermaid
graph LR
  S1[Sprint 1: Radio Signal Metaphor & Sensory Detent] --> S2[Sprint 2: Living Constellation & Co-Presence Realism]
  S2 --> S3[Sprint 3: Sacred Dissolution & Physical Echo Finality]
  S3 --> S4[Sprint 4: Spatial Continuity, Token Polish & v3 Release]
```
